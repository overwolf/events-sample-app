...
export class GEPConsumer {
     ...
     * 
     * @param {overwolf.games.events.InfoUpdates2Event<String, overwolf.games.events.InfoUpdate2>} info - An array of fired info updates
     */
    public onGameInfoUpdate(info: overwolf.games.events.InfoUpdates2Event<String, overwolf.games.events.InfoUpdate2>) {
     ...
     * 
     * @param {overwolf.games.events.NewGameEvents} event - An array of fired Game Events
     */
